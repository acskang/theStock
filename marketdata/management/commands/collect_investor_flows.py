...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if options["use_data_pipeline"]:
            ...
            return
        logger.info(
            "Investor flow auto collection command started",
            extra={
                "event": "command_start",
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"[{mode}] investor flow auto collection complete "
        ...
        logger.info(
            "Investor flow auto collection command completed",
            extra={
    ...
    def _handle_data_pipeline(self, options):
        ...
        logger.info(
            "Investor flow collection delegated to data pipeline",
            extra={
                "event": "command_start",
                "command": "collect_investor_flows",
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"[{mode}] investor flow auto collection complete (data pipeline) "
        ...
        logger.info(
            "Investor flow delegated pipeline completed",
            extra={
                "event": "command_complete",
                "command": "collect_investor_flows",
                "source": provider_name,
